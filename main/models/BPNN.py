...
#
# plt.plot(history_model.history_model['loss'])
# plt.plot(history_model.history_model['val_loss'])
...
# plt.show()
#
# plt.plot(history_model.history_model['accuracy'])
# plt.plot(history_model.history_model['val_accuracy'])
